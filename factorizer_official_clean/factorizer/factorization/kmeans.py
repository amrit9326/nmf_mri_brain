...
class KMeans(nn.Module):
    ...
    def __init__(self, num_centers: int, num_iters: int=10, num_grad_steps: Optional[int]=None, eps: float=1e-16, seed: int=42, verbose: bool=False, *args, **kwargs) -> None:
        super().__init__()
    ...
    def update_u(self, x: Tensor, u: Tensor, v: Tensor) -> tuple[Tensor, Tensor]:
        clusters = self.get_clusters(x, v)
